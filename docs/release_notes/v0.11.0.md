...
* Support for [environment variables as secret store](https://docs.dapr.io/operations/components/setup-secret-store/supported-secret-stores/envvar-secret-store/) for development and updated [Secrets store](https://github.com/liuxd6825/quickstarts/tree/master/secretstore#run-locally) quickstart to use local secret store
...
You can also use the helper scripts outlined [here](https://github.com/liuxd6825/cli#installing-dapr-cli) to get the latest version.
...
Read more [here](https://github.com/liuxd6825/dapr/issues/2016).
...
Similarly the responses from Dapr APIs are now wrapped in a [Response](https://github.com/liuxd6825/java-sdk/blob/master/sdk/src/main/java/io/dapr/client/domain/Response.java) object which contains the actual response and the context associated with it.
