...
- **RESOLVED** use dapr.io/enable-debug: "true" to debug dapr failed [3287](https://github.com/liuxd6825/dapr/issues/3287)
...
### Components
- **RESOLVED** Event-Hub input binding should propagate event meta-data [227](https://github.com/liuxd6825/components-contrib/issues/227)
- **RESOLVED** Add optional support for TTL (Time to Live) for state stores [306](https://github.com/liuxd6825/components-contrib/issues/306)
...
- **RESOLVED** AWS Managed Cassandra State : not working [691](https://github.com/liuxd6825/components-contrib/issues/691)
- **RESOLVED** Azure Storage - getBlobRetryCount [758](https://github.com/liuxd6825/components-contrib/issues/758)
- **RESOLVED** Move The common Redis code to internal [857](https://github.com/liuxd6825/components-contrib/issues/857)
- **RESOLVED** Add backoff for rabbitmq PubSub component [861](https://github.com/liuxd6825/components-contrib/issues/861)
- **RESOLVED** Rabbitmq component goroutine not exit after close [863](https://github.com/liuxd6825/components-contrib/issues/863)
- **RESOLVED** Update Zeebe to version 1.0 [875](https://github.com/liuxd6825/components-contrib/issues/875)
- **RESOLVED** Move retry and config packages to dapr/kit for reuse [893](https://github.com/liuxd6825/components-contrib/issues/893)
- **RESOLVED** Binding to GraphQL [902](https://github.com/liuxd6825/components-contrib/issues/902)
- **RESOLVED** Dapr Mongo State Store component does not support srv record format [904](https://github.com/liuxd6825/components-contrib/issues/904)
- **RESOLVED** Mysql should support more data types. [923](https://github.com/liuxd6825/components-contrib/issues/923)
- **RESOLVED** Hashicorp Vault - using BulkGetSecret (through asp.net core) always return 404 Not Found [925](https://github.com/liuxd6825/components-contrib/issues/925)
- **ADDED** ConsumerId parameter can also be referred as ConsumerGroup for Kafka [928](https://github.com/liuxd6825/components-contrib/issues/928)
- **ADDED** Support Codespaces and VSCode devcontainers in Components-Contrib repo [935](https://github.com/liuxd6825/components-contrib/issues/935)
- **FIXED** Panic when handle Pub/Sub with missing CloudEvent attributes (dapr#3281) [967](https://github.com/liuxd6825/components-contrib/pull/967)
- **RESOLVED** Fix reported 3rd party vulnerabilities [979](https://github.com/liuxd6825/components-contrib/issues/979)
### .NET SDK
...
### Go SDK
- **RESOLVED** Introduce golangci-lint [168](https://github.com/liuxd6825/go-sdk/issues/168)
- **RESOLVED** Invoke: gRPC errors are wrapped multiple times - cannot get the status code [186](https://github.com/liuxd6825/go-sdk/issues/186)
- **RESOLVED** Expose GRPCClient.protoClient [188](https://github.com/liuxd6825/go-sdk/issues/188)
- **RESOLVED** cleanup temp binary file [193](https://github.com/liuxd6825/go-sdk/issues/193)
### Java SDK
...
- **RESOLVED** [CONTENT] Actor sections should mention that only a single state store can be used for actor state [1525](https://github.com/liuxd6825/docs/issues/1525)
