...
- **ADDED** Support for cryptography APIs [491](https://github.com/liuxd6825/js-sdk/pull/491)
...
- **ADDED** Support for cryptography APIs [387](https://github.com/liuxd6825/go-sdk/pull/387)
...
- **FIXED** Dapr returns 200 response instead of 302 for application redirect (version 1.10.2) [6028](https://github.com/liuxd6825/dapr/issues/6028)
...
- **FIXED** Panic while decrypting empty value from state stores [6321](https://github.com/liuxd6825/dapr/pull/6321)
...
- Bindings:
  - AWS SES:
    - Remove required checks for secretKey and accessKey [2698](https://github.com/liuxd6825/components-contrib/issues/2698) [2699](https://github.com/liuxd6825/components-contrib/pull/2699)
  - Azure Service Bus:
    - Allow configuring message headers [2745](https://github.com/liuxd6825/components-contrib/issues/2745)
  - Azure Storage Queues:
    - Added support for authentication with Azure AD [2600](https://github.com/liuxd6825/components-contrib/pull/2600)
    - Polling interval is now configurable [2602](https://github.com/liuxd6825/components-contrib/issues/2602) [2781](https://github.com/liuxd6825/components-contrib/pull/2781)
  - GraphQL:
    - Add support for query variables [2517](https://github.com/liuxd6825/components-contrib/issues/2517) [2701](https://github.com/liuxd6825/components-contrib/pull/2701)
  - HTTP:
    - Response timeout is now customizable [2540](https://github.com/liuxd6825/components-contrib/pull/2540)
    - Added support for mTLS [2765](https://github.com/liuxd6825/components-contrib/issues/2765) [2766](https://github.com/liuxd6825/components-contrib/pull/2766)
    - Added TLS renegotiation [2822](https://github.com/liuxd6825/components-contrib/pull/2822)
  - KubeMQ:
    - Fixed panic and small production issues [2821](https://github.com/liuxd6825/components-contrib/pull/2821)
  - RabbitMQ:
    - New `reconnectWaitInSeconds` metadata property [2565](https://github.com/liuxd6825/components-contrib/pull/2565)
    - Support for mTLS and external authentication with SASL [2656](https://github.com/liuxd6825/components-contrib/pull/2656)
  - Redis:
    - Support GetDel operation [2661](https://github.com/liuxd6825/components-contrib/issues/2661) [2662](https://github.com/liuxd6825/components-contrib/pull/2662)
    - Support Increment Operation and TTL [2654](https://github.com/liuxd6825/components-contrib/pull/2654)
- State stores:
  - All state stores:
    - Allow storing empty string values in all state stores [2722](https://github.com/liuxd6825/components-contrib/issues/2722)
    - Remove native/transactional BulkSet/BulkDelete support for consistency [2834](https://github.com/liuxd6825/components-contrib/pull/2834)
    - etag failures return the proper error on all components [2841](https://github.com/liuxd6825/components-contrib/issues/2841)
  - AWS DynamoDB:
    - Added transaction support [2712](https://github.com/liuxd6825/components-contrib/issues/2712) [2809](https://github.com/liuxd6825/components-contrib/pull/2809)
  - Azure Cosmos DB:
    - Add support for merge partitions [2824](https://github.com/liuxd6825/components-contrib/pull/2824)
  - CockroachDB:
    - Added support for TTLs [2618](https://github.com/liuxd6825/components-contrib/pull/2618)
  - MongoDB:
    - Added support for TTLs [2535](https://github.com/liuxd6825/components-contrib/pull/2535)
    - Can now connect to MongoDB using a `connectionString` metadata option [2659](https://github.com/liuxd6825/components-contrib/pull/2659)
    - Detect replica sets to improve error reporting and transaction support [2732](https://github.com/liuxd6825/components-contrib/pull/2732)
    - Improve BSON serialization to address issues with storing actor reminders [2837](https://github.com/liuxd6825/components-contrib/issues/2837)
  - MySQL:
    - Added support for TTLs [2641](https://github.com/liuxd6825/components-contrib/pull/2641)
    - Improved BulkGet performance with native support [2762](https://github.com/liuxd6825/components-contrib/pull/2762)
  - Oracle database:
    - Component is now beta, including many fixes [2702](https://github.com/liuxd6825/components-contrib/pull/2702)
  - Redis:
    - Fixed handling of JSON in Multi [2734](https://github.com/liuxd6825/components-contrib/pull/2734)
  - RethinkDB:
    - Disable (undocumented) transaction support that was not working correctly [2733](https://github.com/liuxd6825/components-contrib/pull/2733)
  - SQL Server (Azure SQL):
    - Added support for authenticating with Azure AD [2790](https://github.com/liuxd6825/components-contrib/pull/2790)
    - Added support for TTLs [2682](https://github.com/liuxd6825/components-contrib/pull/2682)
    - Case-insensitive matching for `database` in connstring [2694](https://github.com/liuxd6825/components-contrib/pull/2694)
  - SQLite:
    - Improved handling of concurrent access by multiple processes [2485](https://github.com/liuxd6825/components-contrib/issues/2485) [2717](https://github.com/liuxd6825/components-contrib/pull/2717)
- PubSub:
  - Apache Pulsar
    - Add support for End-to-End encryption [2812](https://github.com/liuxd6825/components-contrib/pull/2812) [2531](https://github.com/liuxd6825/components-contrib/issues/2531)
    - Added partition support [2647](https://github.com/liuxd6825/components-contrib/pull/2647)
  - Azure Service Bus components:
    - Allow configuring message headers [2745](https://github.com/liuxd6825/components-contrib/issues/2745)
  - JetStream:
    - Fixed: Competing consumers pattern doesn't work in JetStream [2827](https://github.com/liuxd6825/components-contrib/issues/2827) [2835](https://github.com/liuxd6825/components-contrib/pull/2835)
  - RabbitMQ:
    - Add support for priority queues [2029](https://github.com/liuxd6825/components-contrib/issues/2029) [2680](https://github.com/liuxd6825/components-contrib/pull/2680)
    - Support for external authentication with SASL [2515](https://github.com/liuxd6825/components-contrib/pull/2515)
    - Fixed exchange declare [2764](https://github.com/liuxd6825/components-contrib/issues/2764) [2836](https://github.com/liuxd6825/components-contrib/pull/2836)
  - RocketMQ:
    - Add new configuration options for RocketMQ [2756](https://github.com/liuxd6825/components-contrib/issues/2756) [2811](https://github.com/liuxd6825/components-contrib/pull/2811)
- Middlewares:
  - OAuth2:
    - Fixed: Oauth2 middleware adds Bearer token to request headers. [2615](https://github.com/liuxd6825/components-contrib/issues/2615)
  - OpenID Connect (Bearer):
    - Multiple fixes for Bearer HTTP Middleware [2673](https://github.com/liuxd6825/components-contrib/pull/2673)
  - Open Policy Agent (OPA):
    - Fixed: additional_headers not set on allowed requests [2713](https://github.com/liuxd6825/components-contrib/issues/2713) [2795](https://github.com/liuxd6825/components-contrib/pull/2795)
  - WASM:
    - Changed config to `url` instead of `path` [2817](https://github.com/liuxd6825/components-contrib/pull/2817)
- Nameresolvers:
  - Consul:
    - Consul nameresolver has been improved for performance and stability [2594](https://github.com/liuxd6825/components-contrib/pull/2594)
- Secret stores:
  - Hashicorp Vault:
    - Fix vault prefix empty [2741](https://github.com/liuxd6825/components-contrib/pull/2741)
  - Local env:
    - Adedd `prefix` metadata option [2761](https://github.com/liuxd6825/components-contrib/pull/2761)
- All Azure components now support Azure AD Workload Identity [1567](https://github.com/liuxd6825/components-contrib/issues/1567) [2655](https://github.com/liuxd6825/components-contrib/pull/2655)
- All Azure components can now authenticate using Azure AD with credentials from the Azure CLI, for local development [2469](https://github.com/liuxd6825/components-contrib/issues/2469)
...
- **FIXED** Create new client error [341](https://github.com/liuxd6825/go-sdk/pull/341)
- **CHANGED** Switched router from gorilla/mux to chi [357](https://github.com/liuxd6825/go-sdk/pull/357)
- **ADDED** gRPC options on gRPC server [366](https://github.com/liuxd6825/go-sdk/pull/366)
- **ADDED** Support to set own gRPC server when calling `NewService` [400](https://github.com/liuxd6825/go-sdk/pull/400)
- **ADDED** Support for app to use HTTP protocol with customized headers [404](https://github.com/liuxd6825/go-sdk/issues/404)
- **UPDATED** Update Configuration API Subscribe method [388](https://github.com/liuxd6825/go-sdk/issues/388)
- **UPDATED** Update client's configuration methods with stable config api [392](https://github.com/liuxd6825/go-sdk/issues/392)
- **ADDED** Support for cryptography APIs (alpha) [387](https://github.com/liuxd6825/go-sdk/pull/387)
...
The following components have been **removed** from Dapr 1.11 ([2597](https://github.com/liuxd6825/components-contrib/pull/2597)):
