...
* Local Storage Binding [752](https://github.com/liuxd6825/components-contrib/issues/752)
...
- **RESOLVED** feat(logger): fix typo [2778](https://github.com/liuxd6825/dapr/pull/2778)
...
- **ADDED** blob deletion support in Azure Blob Storage binding [681](https://github.com/liuxd6825/components-contrib/issues/681)
- **RESOLVED** Avoid using github.com/satori/go.uuid [703](https://github.com/liuxd6825/components-contrib/issues/703)
- **ADDED** message redelivery and improved concurrency settings for Redis PubSub [710](https://github.com/liuxd6825/components-contrib/issues/710)
- **ADDED** Retries to handle MQTT message error and acknowledge processed messages [720](https://github.com/liuxd6825/components-contrib/issues/720)
- **ADDED** Retries to handle Hazelcast message errors [723](https://github.com/liuxd6825/components-contrib/issues/723)
- **ADDED** `eTag` support for MongoDB state store [726](https://github.com/liuxd6825/components-contrib/issues/726)
- **RESOLVED** GetResponse does not return nil eTag in state store [731](https://github.com/liuxd6825/components-contrib/issues/731)
- **RESOLVED** Storing `byte[]` value in CosmoDB state component [745](https://github.com/liuxd6825/components-contrib/issues/745)
- **ADDED** AWS SSM Parameter store component as secret store [746](https://github.com/liuxd6825/components-contrib/issues/746)
- **RESOLVED** Local Storage Binding [752](https://github.com/liuxd6825/components-contrib/issues/752)
- **RESOLVED** refactor GCP pubsub [760](https://github.com/liuxd6825/components-contrib/pull/760)
- **RESOLVED** fix pubsub redis close bug [769](https://github.com/liuxd6825/components-contrib/pull/769)
...
- **RESOLVED** fix go-sdk example doc [144](https://github.com/liuxd6825/go-sdk/pull/144)
- **RESOLVED** Update pub.go [145](https://github.com/liuxd6825/go-sdk/pull/145)
- **RESOLVED** doc: fix typo [148](https://github.com/liuxd6825/go-sdk/pull/148)
- **RESOLVED** feat: add shutdown [151](https://github.com/liuxd6825/go-sdk/pull/151)
