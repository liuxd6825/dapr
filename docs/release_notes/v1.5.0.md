...
Virtual actors are now available in the Dapr Go SDK. See [go-sdk/21](https://github.com/liuxd6825/go-sdk/issues/21) for details.

For a Dapr actor example using the Go SDK, see [go-sdk/examples/actor](https://github.com/liuxd6825/go-sdk/tree/main/examples/actor).
...
### Components
- **RESOLVED** Certify Azure SQL Server as stable in state store [949](https://github.com/liuxd6825/components-contrib/issues/949)
- **RESOLVED** Certify Apache Kafka as stable in pubsub [953](https://github.com/liuxd6825/components-contrib/issues/953) [1241](https://github.com/liuxd6825/components-contrib/pull/1241)
- **RESOLVED** Certify Azure Key Vault w/ Managed Identity as stable in secret store [959](https://github.com/liuxd6825/components-contrib/issues/959)
- **ADDED** User agent header for Azure services [1014](https://github.com/liuxd6825/components-contrib/issues/1014)
- **ADDED** Azure Service Bus message metadata for Pubsub [1071](https://github.com/liuxd6825/components-contrib/pull/1071)
- **ADDED** Delay queue params for Pulsar [1107](https://github.com/liuxd6825/components-contrib/pull/1107)
- **FIXED** Postgres state store and add it to conformance tests [1117](https://github.com/liuxd6825/components-contrib/issues/1117)
- **ADDED** Mysql conformance test [1122](https://github.com/liuxd6825/components-contrib/issues/1122) [1168](https://github.com/liuxd6825/components-contrib/issues/1168)
- **ADDED** Enhancements to CREATE operation GCP Storage Bucket binding + adds GET, DELETE and LIST [1125](https://github.com/liuxd6825/components-contrib/issues/1125)
- **FIXED** Azure Storage Queue resolving extra double quotation [1130](https://github.com/liuxd6825/components-contrib/issues/1130)
- **RESOLVED** Update Azure Service Bus Go SDK to latest [1141](https://github.com/liuxd6825/components-contrib/issues/1141)
- **RESOLVED** RabbitMQ binding uses text/plain as content type [1144](https://github.com/liuxd6825/components-contrib/issues/1144)
- **RESOLVED** Pass the message body in OPA middleware [1166](https://github.com/liuxd6825/components-contrib/issues/1166)
- **FIXED** RabbitMQ pubsub ignores 'durable' metadata [1181](https://github.com/liuxd6825/components-contrib/issues/1181)
- **FIXED** RabbitMQ pubsub does not handle channel closing properly [1187](https://github.com/liuxd6825/components-contrib/issues/1187)
- **FIXED** TLS with Kafka pubsub component [1188](https://github.com/liuxd6825/components-contrib/issues/1188)
- **UPDATED** paho.mqtt.golang to v1.3.5 [1192](https://github.com/liuxd6825/components-contrib/pull/1192)
- **RESOLVED** binding/mysql: optimize output error [1195](https://github.com/liuxd6825/components-contrib/pull/1195)
- **RESOLVED** Reconnect RabbitMQ on 'unexpected command received' error [1198](https://github.com/liuxd6825/components-contrib/pull/1198)
- **RESOLVED** add metadata to query request/response [1215](https://github.com/liuxd6825/components-contrib/pull/1215)
- **ADDED** Support message-id property from IoTHub device events in EventHubs [1221](https://github.com/liuxd6825/components-contrib/pull/1221)
- **RESOLVED** restrict sns/sqs pubsub subscription permissions [1230](https://github.com/liuxd6825/components-contrib/issues/1230)
- **FIXED** MQTT bindings can hang on Close() [1235](https://github.com/liuxd6825/components-contrib/issues/1235)
- **RESOLVED** Body of email empty in SMTP binding when invoking the binding over gRPC [1253](https://github.com/liuxd6825/components-contrib/issues/1253)
- **FIXED** Body content parsing for SMTP binding [1254](https://github.com/liuxd6825/components-contrib/pull/1254)
- **ADDED** Warning generated by SMTP binding when username and password are both set. [1255](https://github.com/liuxd6825/components-contrib/issues/1255)
- **ADDEDED**  Option to override Kafka Broker version [1275](https://github.com/liuxd6825/components-contrib/pull/1275)
- **RESOLVED** Renamed package for CosmosDB.GramlinAPI binding component [1276](https://github.com/liuxd6825/components-contrib/pull/1276)
### Dashboard
...
### .NET SDK
- **RESOLVED** Support .net 6 preview 4 new Minimal APIs [695](https://github.com/liuxd6825/dotnet-sdk/issues/695)
...
### Go SDK
- **ADDED** Actor support [21](https://github.com/liuxd6825/go-sdk/issues/21)
- **RESOLVED** Add metadata support for PublishEvent API [164](https://github.com/liuxd6825/go-sdk/issues/164)
- **RESOLVED** Rationalize PublishEvent* APIs [174](https://github.com/liuxd6825/go-sdk/issues/174)
- **RESOLVED** By default, gRPC limits incoming messages to 4 MB and expose parameter to allow user to set the limit [189](https://github.com/liuxd6825/go-sdk/issues/189)
- **RESOLVED** Decode data_base64 cloudEvent for http service [201](https://github.com/liuxd6825/go-sdk/pull/201)
- **FIXED** HTTP service stop method doesn't do anything [208](https://github.com/liuxd6825/go-sdk/issues/208)
- **RESOLVED** Dapr client doesn't report failure when instantiated without a daprd connection [212](https://github.com/liuxd6825/go-sdk/issues/212)
- **RESOLVED** Make client init fail if server connection fails [213](https://github.com/liuxd6825/go-sdk/pull/213)
### Python SDK
