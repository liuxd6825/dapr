...
- **RESOLVED** Make missing app-id annotation have a clearer log message [2603](https://github.com/liuxd6825/dapr/issues/2603)
...
- **FIXED** Workaround to allow dapr to be run with rosetta on M1 macs [570](https://github.com/liuxd6825/cli/issues/570)
...
- **RESOLVED** Dapr pub/sub publish is stripping Cloud Event fields [506](https://github.com/liuxd6825/components-contrib/issues/506)

- **RESOLVED** Document when to release a new version of a component [526](https://github.com/liuxd6825/components-contrib/issues/526)

- **RESOLVED** Can't load oauth2 middleware in dapr1.0-rc1 kubernetes [537](https://github.com/liuxd6825/components-contrib/issues/537)

- **RESOLVED** Update the Secrets Component documentation [559](https://github.com/liuxd6825/components-contrib/issues/559)

- **RESOLVED** Add prefetch count to RabbitMQ pub/sub [560](https://github.com/liuxd6825/components-contrib/issues/560)

- **FIXED** Kubernetes get secret to fallback to k8s namespace. [563](https://github.com/liuxd6825/components-contrib/issues/563)

- **RESOLVED** Add concurrency to RabbitMQ [574](https://github.com/liuxd6825/components-contrib/issues/574)

- **RESOLVED** Exclusive Queues for RabbitMQ [577](https://github.com/liuxd6825/components-contrib/issues/577)

- **RESOLVED** Added Exclusive Flag to RabbitMQ queues [580](https://github.com/liuxd6825/components-contrib/pull/580)

- **RESOLVED** Support priority queue for RabbitMQ Bind/Pubsub Components [582](https://github.com/liuxd6825/components-contrib/issues/582)

- **RESOLVED** App able to subscribe to one GCP Pub/Sub topic only [583](https://github.com/liuxd6825/components-contrib/issues/583)

- **RESOLVED** Shared Subscription in MQTT [589](https://github.com/liuxd6825/components-contrib/issues/589)

- **RESOLVED** SecretStore BulkGetSecret method flattens all of secrets into a single map [590](https://github.com/liuxd6825/components-contrib/issues/590)

- **RESOLVED** Update sample links [611](https://github.com/liuxd6825/components-contrib/pull/611)

- **RESOLVED** Need a MySQL binding support similar with PostgreSQL [616](https://github.com/liuxd6825/components-contrib/issues/616)

- **RESOLVED** Fix get bulk secret for hashicorp vault. [632](https://github.com/liuxd6825/components-contrib/pull/632)

- **RESOLVED** Fix service bus new topic creation [636](https://github.com/liuxd6825/components-contrib/pull/636)
...
- **RESOLVED** add metadata in state get response [128](https://github.com/liuxd6825/go-sdk/pull/128)

- **RESOLVED** fix some typo [131](https://github.com/liuxd6825/go-sdk/pull/131)

- **RESOLVED** Update SDK to support new etag mechanism, change BulkGetSecrets [134](https://github.com/liuxd6825/go-sdk/issues/134)

- **RESOLVED** Add support for etag and bulk secret modifications [135](https://github.com/liuxd6825/go-sdk/pull/135)
...
- **ADDED** examples on how to write Unit tests with DaprClient and Actors. [470](https://github.com/liuxd6825/java-sdk/issues/470)
...
- **RESOLVED** Fix typo in Kubernetes binding docs [1060](https://github.com/liuxd6825/docs/pull/1060)
...
- **RESOLVED** Remove unstable dependencies. [136](https://github.com/liuxd6825/go-sdk/issues/136)
