...
- Added a [bulk secrets API](https://docs.dapr.io/reference/api/secrets_api/#get-bulk-secret) to get all the secrets at once from a secret store that the app has access to. Implemented in the [secret components](https://github.com/liuxd6825/components-contrib/tree/master/secretstores)
...
- **RESOLVED** Azure Blob Storage Binding Expecting String for Data [492](https://github.com/liuxd6825/components-contrib/issues/492)
- **RESOLVED** Remove Exporter Components now OpenTelemetry is adopted.  [508](https://github.com/liuxd6825/components-contrib/issues/508)
- **RESOLVED** Allow DynamoDB state store to resolve credentials using AWS SDK credentials chain [647](https://github.com/liuxd6825/components-contrib/issues/647)
- **RESOLVED** Support Kafka partition key in Pub/Sub [667](https://github.com/liuxd6825/components-contrib/issues/667)
- **FIXED** handling of key not found in mongodb to return empty result instead of errror. [684](https://github.com/liuxd6825/components-contrib/issues/684)
- **RESOLVED** Error when saving byte[] in cosmosdb [685](https://github.com/liuxd6825/components-contrib/issues/685)
- **RESOLVED** Kafka pubsub can drop message in partial failures [687](https://github.com/liuxd6825/components-contrib/issues/687)
...
- **RESOLVED** Updates for next runtime RC [142](https://github.com/liuxd6825/go-sdk/issues/142)
...
- **RESOLVED** Add documentation for the "--dapr-http-max-request-size" argument for the CLI and "dapr.io/http-max-request-size"  annotation [1099](https://github.com/liuxd6825/docs/issues/1099)
