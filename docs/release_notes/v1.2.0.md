...
If you're new to Dapr, visit the [getting started](https://docs.dapr.io/getting-started/) page and familiarize yourself with Dapr.
 ...
 - Many **new components**:
     - Alibaba Cloud DingTalk Webhook as Binding [811](https://github.com/liuxd6825/components-contrib/issues/811)
     - Zeebe Workflow Engine as Binding [805](https://github.com/liuxd6825/components-contrib/issues/805)
     - Alibaba Sentinel as Middleware [828](https://github.com/liuxd6825/components-contrib/issues/828)
...
- **ADDED**  nodeselector option in helm chart [3113](https://github.com/liuxd6825/dapr/issues/3113)
...
### Components
- **RESOLVED** Support of Azure Blob Metadata (for Blob state storage) [462](https://github.com/liuxd6825/components-contrib/issues/462)
- **RESOLVED** Add DNS name resolver. Add unit tests. [743](https://github.com/liuxd6825/components-contrib/pull/743)
- **ADDED** NameResolution: Consul [749](https://github.com/liuxd6825/components-contrib/issues/749)
- **FIXED** Password configuration for Redis Sentinel state store. [756](https://github.com/liuxd6825/components-contrib/issues/756)
- **UPDATED** Optimize SMTP binding performance [781](https://github.com/liuxd6825/components-contrib/issues/781)
- **RESOLVED** Update Readme.md [789](https://github.com/liuxd6825/components-contrib/pull/789)
- **RESOLVED** Fixed bug where default vaultaddr is never used. [791](https://github.com/liuxd6825/components-contrib/pull/791)
- **RESOLVED** customize cluster domain of k8s nameresolution [792](https://github.com/liuxd6825/components-contrib/issues/792)
- **RESOLVED** Hashicorp Vault - accept root token as string instead of file [794](https://github.com/liuxd6825/components-contrib/issues/794)
- **RESOLVED** Use `go mod tidy` before make [799](https://github.com/liuxd6825/components-contrib/pull/799)
- **RESOLVED** Upgrade redis client to v8 and use context in redis pubsub component to cancel request [804](https://github.com/liuxd6825/components-contrib/pull/804)
- **RESOLVED** Implement bindings for the Zeebe workflow engine [805](https://github.com/liuxd6825/components-contrib/issues/805)
- **RESOLVED** Error amqp:link:detach-forced [809](https://github.com/liuxd6825/components-contrib/issues/809)
- **RESOLVED** Alibaba Cloud DingTalk Webhook Binding [811](https://github.com/liuxd6825/components-contrib/issues/811)
- **RESOLVED** Add redis cluter mode for pubsub [823](https://github.com/liuxd6825/components-contrib/pull/823)
- **RESOLVED** optimize(state/redis): output detail redis error [825](https://github.com/liuxd6825/components-contrib/pull/825)
- **RESOLVED** Sentinel as Dapr's middleware [828](https://github.com/liuxd6825/components-contrib/issues/828)
- **RESOLVED** Add timeout to cancel request for it would be redelivered [832](https://github.com/liuxd6825/components-contrib/pull/832)
- **RESOLVED** Add optional metadata param maxLen for redis stream PubSub component [835](https://github.com/liuxd6825/components-contrib/pull/835)
- **RESOLVED** add BulkGetResponse comments [845](https://github.com/liuxd6825/components-contrib/pull/845)
- **FIXED** Redis subscriber should not block infinitely on XReadGroup [852](https://github.com/liuxd6825/components-contrib/issues/852)
- **RESOLVED** Make the retry package available to use across all components [853](https://github.com/liuxd6825/components-contrib/issues/853)
- **RESOLVED** Dapr CLI commands take ~5 seconds to execute [865](https://github.com/liuxd6825/components-contrib/issues/865)
- **RESOLVED** Update Aerospike to v4.5.0 [866](https://github.com/liuxd6825/components-contrib/pull/866)
- **FIXED** Race in pulsar pubsub component. [867](https://github.com/liuxd6825/components-contrib/issues/867)
### .NET SDK
...
- **RESOLVED** Add Alibaba Cloud DingTalk Webhook binding doc [1407](https://github.com/liuxd6825/docs/pull/1407)
