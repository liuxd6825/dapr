...
- State store API now [returns TTL](https://v1-b12.docs.dapr.io/reference/api/state_api/) as part of the response metadata, allowing applications to make caching decisions based on the remaining time. [2987](https://github.com/liuxd6825/components-contrib/pull/2987)
...
- Added support for Dapr sidecar Metadata API [290](https://github.com/liuxd6825/go-sdk/issues/290)
...
- **ADDED** API to retrieve placement table from placement service [6033](https://github.com/liuxd6825/dapr/issues/6033) [6732](https://github.com/liuxd6825/dapr/pull/6732)
...
- **FIXED** PubSub's CloudEvent trace fields can't be customized when using custom CloudEvent [6800](https://github.com/liuxd6825/dapr/issues/6800) [components-contrib#3080](https://github.com/liuxd6825/components-contrib/pull/3080)
...
- **Bindings**:
  - Azure OpenAI:
    - New component: output binding for Azure OpenAI [2965](https://github.com/liuxd6825/components-contrib/pull/2965) [3022](https://github.com/liuxd6825/components-contrib/pull/3022) [2716](https://github.com/liuxd6825/components-contrib/issues/2716)
  - Azure SignalR:
    - Added client negotiate support [3073](https://github.com/liuxd6825/components-contrib/pull/3073)
  - Azure Storage Queues:
    - Messages sent to Dapr now contain additional metadata including dequeue count [3028](https://github.com/liuxd6825/components-contrib/pull/3028) [2375](https://github.com/liuxd6825/components-contrib/issues/2375)
  - HTTP:
    - [Breaking change] When reading a response, the amount of data read is capped at "maxResponseBodySize" as set in the metadata, with 100Mi as default [3040](https://github.com/liuxd6825/components-contrib/pull/3040)
    - Fixed a number of bugs, including inability to invoke URLs that contained `..` [2981](https://github.com/liuxd6825/components-contrib/pull/2981)
  - Kafka:
    - Added metadata option `oauthbearer.extensions` [3008](https://github.com/liuxd6825/components-contrib/issues/3008)
  - Kubernetes:
    - [Breaking change] Path to kubeconfig file is now passed as metadata option and not as CLI flag [2992](https://github.com/liuxd6825/components-contrib/pull/2992) [3060](https://github.com/liuxd6825/components-contrib/pull/3060)
  - Local storage:
    - Disable access to some more system folders for security reasons [2947](https://github.com/liuxd6825/components-contrib/pull/2947)
  - MySQL:
    - Added support for parametrized queries [2973](https://github.com/liuxd6825/components-contrib/issues/2973)
  - PostgreSQL:
    - Added support for parametrized queries [2972](https://github.com/liuxd6825/components-contrib/pull/2972)
    - Added support for pgBouncer via `queryExecMode` [3002](https://github.com/liuxd6825/components-contrib/issues/3002) [3103](https://github.com/liuxd6825/components-contrib/pull/3103)
    - It is now possible to authenticate to Azure Database for PostgreSQL using Azure AD [2595](https://github.com/liuxd6825/components-contrib/issues/2595)
  - RabbitMQ:
    - Use metadata from request as header of the published message [2895](https://github.com/liuxd6825/components-contrib/pull/2895) [3030](https://github.com/liuxd6825/components-contrib/issues/3030)
  - Twilio Sendgrid:
    - Added support for dynamic templates [2412](https://github.com/liuxd6825/components-contrib/issues/2412) [2844](https://github.com/liuxd6825/components-contrib/pull/2844)
  - WASM:
    - Added support for strict sandboxing [2884](https://github.com/liuxd6825/components-contrib/pull/2884)
    - Added support for fetching WASM files via HTTP(S) [3005](https://github.com/liuxd6825/components-contrib/pull/3005)
    - Added support for wasi-http [3007](https://github.com/liuxd6825/components-contrib/pull/3007)
  - Zeebe:
    - Component is now stable [3111](https://github.com/liuxd6825/components-contrib/issues/3111) [3112](https://github.com/liuxd6825/components-contrib/pull/3112) [2941](https://github.com/liuxd6825/components-contrib/issues/2941) [2942](https://github.com/liuxd6825/components-contrib/issues/2942)
- **Configuration stores**:
  - Azure App Configuration:
    - [Breaking change] Metadata options have been changed to support Go durations (or seconds) instead of nanoseconds [2976](https://github.com/liuxd6825/components-contrib/issues/2976) [3004](https://github.com/liuxd6825/components-contrib/pull/3004)
  - PostgreSQL:
    - Added support for pgBouncer via `queryExecMode` [3002](https://github.com/liuxd6825/components-contrib/issues/3002) [3103](https://github.com/liuxd6825/components-contrib/pull/3103)
    - It is now possible to authenticate to Azure Database for PostgreSQL using Azure AD [2595](https://github.com/liuxd6825/components-contrib/issues/2595)
- **Crypto providers**:
...
- **Middlewares**:
  - Router alias:
    - Changed the format of the metadata the component accepts [2903](https://github.com/liuxd6825/components-contrib/pull/2903)
  - WASM:
    - Added support for strict sandboxing [2884](https://github.com/liuxd6825/components-contrib/pull/2884)
    - Added ability to pass config to guests [2918](https://github.com/liuxd6825/components-contrib/pull/2918)
    - Added support for fetching WASM files via HTTP(S) [3005](https://github.com/liuxd6825/components-contrib/pull/3005)
- **Name resolvers**:
  - Consul:
    - Fixed resolution of IPv6 addresses. [3074](https://github.com/liuxd6825/components-contrib/issues/3074)
    - Consul now handles conflicts where an app is deployed at an address that previously was used by a different app (with a different ID) [2489](https://github.com/liuxd6825/components-contrib/issues/2489) [2980](https://github.com/liuxd6825/components-contrib/pull/2980) [2490](https://github.com/liuxd6825/components-contrib/pull/2490) [dapr#6642](https://github.com/liuxd6825/dapr/pull/6642)
  - Kubernetes:
    - Added templating capabilities for the name resolver [2883](https://github.com/liuxd6825/components-contrib/pull/2883)
- **PubSub**:
  - JetStream:
    - Added support for delaying redelivery of failed messages [3079](https://github.com/liuxd6825/components-contrib/issues/3079) [3102](https://github.com/liuxd6825/components-contrib/pull/3102)
  - Kafka:
    - Added metadata option `oauthbearer.extensions` [3008](https://github.com/liuxd6825/components-contrib/issues/3008)
  - NATS Streaming:
    - Because the NATS Streaming project is deprecated, the Dapr component has been deprecated too. It will be removed in Dapr 1.13 [3042](https://github.com/liuxd6825/components-contrib/issues/3042) [3043](https://github.com/liuxd6825/components-contrib/pull/3043)
  - Pulsar:
    - Added consumer proto schema validation [3014](https://github.com/liuxd6825/components-contrib/pull/3014)
  - RabbitMQ:
    - Added support for quorum queues [2544](https://github.com/liuxd6825/components-contrib/issues/2544)
    - Added option to override queue name via subscription request metadata [2791](https://github.com/liuxd6825/components-contrib/issues/2791) [2962](https://github.com/liuxd6825/components-contrib/pull/2962)
    - Added metadata option to override client name [2933](https://github.com/liuxd6825/components-contrib/pull/2933)
- **Secret stores**:
  - Kubernetes:
    - [Breaking change] Path to kubeconfig file is now passed as metadata option and not as CLI flag [2992](https://github.com/liuxd6825/components-contrib/pull/2992) [3060](https://github.com/liuxd6825/components-contrib/pull/3060
- **State stores**:
  - Etcd:
    - Published version "v2" of the component which includes some non-backwards compatible fixes to better support TTLs [2932](https://github.com/liuxd6825/components-contrib/pull/2932)
  - PostgreSQL:
    - It is now possible to authenticate to Azure Database for PostgreSQL using Azure AD [2595](https://github.com/liuxd6825/components-contrib/issues/2595)
    - Added support for pgBouncer via `queryExecMode` [3002](https://github.com/liuxd6825/components-contrib/issues/3002) [3103](https://github.com/liuxd6825/components-contrib/pull/3103)
  - When retrieving state from a state store that supports TTLs, the additional metadata property `ttlExpiryTime` is returned for these state stores:
    - AWS DynamoDB [2899](https://github.com/liuxd6825/components-contrib/pull/2899) [2857](https://github.com/liuxd6825/components-contrib/issues/2857)
    - Azure Cosmos DB [2898](https://github.com/liuxd6825/components-contrib/pull/2898) [2857](https://github.com/liuxd6825/components-contrib/issues/2857)
    - Cassandra [2889](https://github.com/liuxd6825/components-contrib/pull/2889) [2857](https://github.com/liuxd6825/components-contrib/issues/2857)
    - CockroachDB [2864](https://github.com/liuxd6825/components-contrib/pull/2864) [2857](https://github.com/liuxd6825/components-contrib/issues/2857)
    - Etcd (v2) [2932](https://github.com/liuxd6825/components-contrib/pull/2932) [2857](https://github.com/liuxd6825/components-contrib/issues/2857)
    - In-memory [2870](https://github.com/liuxd6825/components-contrib/pull/2870) [2857](https://github.com/liuxd6825/components-contrib/issues/2857)
    - Microsoft SQL Server [2896](https://github.com/liuxd6825/components-contrib/pull/2896) [2857](https://github.com/liuxd6825/components-contrib/issues/2857
    - MongoDB [2888](https://github.com/liuxd6825/components-contrib/pull/2888) [2857](https://github.com/liuxd6825/components-contrib/issues/2857
    - MySQL [2871](https://github.com/liuxd6825/components-contrib/pull/2871) [2857](https://github.com/liuxd6825/components-contrib/issues/2857
    - Oracle Database [2897](https://github.com/liuxd6825/components-contrib/pull/2897) [2857](https://github.com/liuxd6825/components-contrib/issues/2857
    - PostgreSQL [2864](https://github.com/liuxd6825/components-contrib/pull/2864) [2857](https://github.com/liuxd6825/components-contrib/issues/2857)
    - SQLite [2869](https://github.com/liuxd6825/components-contrib/pull/2869) [2857](https://github.com/liuxd6825/components-contrib/issues/2857)
...
### Go SDK
- **ADDED** Support for Dapr sidecar Metadata API [290](https://github.com/liuxd6825/go-sdk/issues/290)
- **FIXED** Serialization error - Actor codec is ignored by client [317](https://github.com/liuxd6825/go-sdk/issues/317)
- **UPDATED** Update Readme.md to include installtion guide [433](https://github.com/liuxd6825/go-sdk/pull/433)
- **FIXED** configuration example does not work out of the box [447](https://github.com/liuxd6825/go-sdk/issues/447)
- **ADDED** Log SDK version as gRPC user agent [421](https://github.com/liuxd6825/go-sdk/pull/421)
...
- The **HTTP Binding** now has a default `maxResponseBodySize` of 100 MB, for security reasons [components-contrib#3040](https://github.com/liuxd6825/components-contrib/pull/3040)
- Azure App Config: fix time format to time.duration [components-contrib#3004](https://github.com/liuxd6825/components-contrib/pull/3004)
