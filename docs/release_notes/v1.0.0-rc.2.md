...
* Added a [bulk secrets API](https://v1-rc2.docs.dapr.io/reference/api/secrets_api/#get-bulk-secret) to get all the secrets at once from a secret store that the app has access to. Implemented in the [secret components](https://github.com/liuxd6825/components-contrib/tree/master/secretstores)
...
- **RESOLVED** Dapr health endpoint is incorrectly reporting healthy if bindings have failed to initialize [2437](https://github.com/liuxd6825/dapr/issues/2437)
...
- **ADDED** new shorthands for different flags [531](https://github.com/liuxd6825/cli/issues/531)
...
- **RESOLVED** Expand the secret store implementation to provide a method to retrieve all secrets from a store [309](https://github.com/liuxd6825/components-contrib/issues/309)

- **RESOLVED** Goroutine leak in ASB pubsub when message cannot be completed/abandoned [376](https://github.com/liuxd6825/components-contrib/issues/376)

- **RESOLVED** Have Dapr support multiple instances registered with same app-id and load balance requests across them [514](https://github.com/liuxd6825/components-contrib/issues/514)

- **RESOLVED** State Management Couchbase Components, Deserialize Problem [518](https://github.com/liuxd6825/components-contrib/issues/518)

- **RESOLVED** Azure Key Vault Secret Store can read different secret versions. [522](https://github.com/liuxd6825/components-contrib/issues/522)

- **RESOLVED** Getting a weird error when trying to log more [529](https://github.com/liuxd6825/components-contrib/issues/529)

- **ADDED** Postmark output binding [545](https://github.com/liuxd6825/components-contrib/issues/545)

- **RESOLVED** Add access level to Azure Blob Storage [548](https://github.com/liuxd6825/components-contrib/issues/548)

- **FIXED** Bug in flattening of JSON hierarchy by local file secrets store. [550](https://github.com/liuxd6825/components-contrib/issues/550)
...
- **UPDATED** Configuration to auto-fill screen [105](https://github.com/liuxd6825/dashboard/issues/105) [106](https://github.com/liuxd6825/dashboard/issues/106) [107](https://github.com/liuxd6825/dashboard/issues/107)
...
- **RESOLVED** Cancel gRPC returns error [100](https://github.com/liuxd6825/go-sdk/issues/100)

- **ADDED** Expose HTTP/gRPC server address on created client [111](https://github.com/liuxd6825/go-sdk/issues/111)

- **UPDATE** Have consistent method/parameter names across SDKs [117](https://github.com/liuxd6825/go-sdk/issues/117)

- **ADDED** Parameterize request method verb on service invocation [118](https://github.com/liuxd6825/go-sdk/issues/118)

- **ADDED** Support HTTP query string on method invoke [125](https://github.com/liuxd6825/go-sdk/issues/125)
...
- **UPDATED** CLI reference documentation. [972](https://github.com/liuxd6825/docs/issues/972)
...
- **RESOLVED** Have consistent method/parameter names across SDKs [117](https://github.com/liuxd6825/go-sdk/issues/117)
