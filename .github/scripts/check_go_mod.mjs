...
//
// replace github.com/liuxd6825/dapr-components-contrib => ../components-contrib
//
...
if (!read.includes(match)) {
    console.log(
        'File go.mod was committed with a change in the block around "replace github.com/liuxd6825/dapr-components-contrib"'
    )
    process.exit(1)
}
